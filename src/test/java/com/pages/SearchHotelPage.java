...
public class SearchHotelPage extends BaseClass{
	...
	private WebElement beforethanCheckOutDate;
	@FindBy(id="checkout_span")
	private WebElement afterthanCheckInDate;
	
	public WebElement getPleaseSelectHotel() {
		return pleaseSelectHotel;
	}
	public WebElement getBeforethanCheckOutDate() {
		return beforethanCheckOutDate;
	}
	public WebElement getAfterthanCheckInDate() {
		return afterthanCheckInDate;
	}
